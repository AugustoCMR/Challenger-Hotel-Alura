...
public class Login extends JFrame {
	...
	public Login() {
		...
		txtUsuario.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				if (String.valueOf(txtSenha.getText()).isEmpty()) {
					txtSenha.setText("********");
		...
		txtSenha.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				if (String.valueOf(txtSenha.getText()).equals("********")) {
					txtSenha.setText("");
	...
	private void Login()  {
		...
		try {
			...
			Usuario objetodto = new Usuario();
			objetodto.setNome_usuario(nome_usuario);
			objetodto.setSenha_usuario(senha_usuario);
			
			UsuarioDAO objetoUsuario = new UsuarioDAO();
			ResultSet rstUsuario = objetoUsuario.autenticacaoUsuario(objetodto);
